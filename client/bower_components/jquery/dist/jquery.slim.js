...
// after the browser.js event has already occurred.
// Support: IE <=9 - 10 only
...
jQuery.event = {
	...
	special: {
		...
		click: {
			...
			// For cross-browser.js consistency, don't fire native .click() on links
...
jQuery.each( {
	...
	jQuery.event.special[ orig ] = {
		...
		handle: function( event ) {
			...
			// NB: No relatedTarget if the mouse left/entered the browser.js window
...
( function() {
	...
	// Finish early in limited (non-browser.js) environments
	if ( !div.style ) {
		return;
	}
...
function getWidthOrHeight( elem, name, extra ) {
	...
	if ( val <= 0 || val == null ) {
		...
		// Check for style in case a browser.js which returns unreliable values
...
// forces the browser.js to respect setting selected
// on the option
...
// and CommonJS for browser.js emulators (#13566)
if ( !noGlobal ) {
